...
export const NXPC_TOKEN_ADDRESS = '0x5E0E90E268BC247Cc850c789A0DB0d5c7621fb59'; // NXPC token contract address
...
export const NXPC_DEPLOYED_BLOCK = 61980483; // Avalanche block number
// export const NXPC_DEPLOYED_BLOCK = 62125766; // Avalanche block number
